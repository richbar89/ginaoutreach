    ...
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
        ...
        >
          ...
          <h2 className="text-lg font-semibold text-slate-900 mb-1">Send an Email</h2>
        ...
        >
          ...
          <h2 className="text-lg font-semibold text-slate-900 mb-1">New Campaign</h2>
          <p className="text-sm text-slate-500 leading-relaxed">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="flex gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-slate-800">No setup required</p>
          ...
          <div className="flex gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-slate-800">Your data stays local</p>
              <p className="text-xs text-slate-500 mt-0.5 leading-relaxed">
          ...
          <div className="flex gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-slate-800">Personalisation built in</p>
              <p className="text-xs text-slate-500 mt-0.5 leading-relaxed">
                Use merge tags like{" "}
                <code className="text-xs bg-slate-100 px-1 py-0.5 rounded font-mono">{"{{name}}"}</code>{" "}
